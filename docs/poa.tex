...
Each member is expected to spend a minimum of 14 hours per week on the project with the responsibility for each member to record their worked hours and task in the timesheet provided in the github. If a member spends 50 extra hours on the project they may gain a total of 0.5 extra points when dividing individual efforts during the assessment. Besides this, the project leader runs a script each friday to keep track of time spent on the project for each member.
\subsection{Task management}

To keep track of tasks per member, the project makes use of a kanban board in combination with the tasks mentioned in the time registration. This board is used during standups in which the tasks per member can be updated and discussed. 
\\\\
...
\begin{center}
    \begin{tabular}{| p{0.05\linewidth} | p{0.4\linewidth} | p{0.4\linewidth} |}
        ...
        Nr. & Consequence                                                                                                                                   & Mitigation                                                                               \\ [0.5ex]
        \hline\hline
        2.1 & Parts of the project may be delayed or remain unfinished                                                                                      & The project makes use of a buddy system in which knowledge is shared and tasks can be temporarily taken over by their designated buddy                                                                            \\
        \hline
