...
TEST_F(PhysicsTest, updateloop)
{
	...
	ASSERT_NO_THROW(physicsManager->startPhysicsEngine({0.0f, 0.0f}));
	ASSERT_NO_THROW(physicsManager->updatePhysicsEngine());

	ASSERT_NO_THROW(physicsManager->getPhysicsEngine());
}
