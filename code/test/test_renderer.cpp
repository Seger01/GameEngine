...
TEST_F(RendererTest, RenderSquare)
{
	ASSERT_NO_THROW((
		[&]()
		{
			...
			mRenderer->renderSquare(Vector2(200, 200), 50, 50, 0, color, true);

			mRenderer->renderSquare(Vector2(200, 200), 50, 50, 45.0f, color, true);

			mRenderer->renderSquare(Vector2(-200000, 20000), -50, 50, 0, color, false);
			mRenderer->renderSquare(Vector2(-200000, 20000), -50, 50, 0, color, true);
		}()));
}
