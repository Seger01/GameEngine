...
enum class Key {
    ...
    Controller_X = 302,
    Controller_Y = 303,
    Controller_LeftBumper = 304,
    Controller_RightBumper = 305,
    Controller_Back = 306,
    Controller_Start = 307,
    Controller_LeftStick_Press = 308,
    Controller_RightStick_Press = 309,
    Controller_DPad_Up = 310,
    Controller_DPad_Down = 311,
    Controller_DPad_Left = 312,
    Controller_DPad_Right = 313,

    Controller_LeftStick_Up = 314,
    Controller_LeftStick_Left = 315,
    Controller_LeftStick_Down = 316,
    Controller_LeftStick_Right = 317,

    Controller_RightStick_Up = 318,
    Controller_RightStick_Left = 319,
    Controller_RightStick_Down = 320,
    Controller_RightStick_Right = 321,
