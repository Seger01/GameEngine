 ...
 * @details This class creates a level from the parsed json data by creating game objects with sprites, colliders and
 * rigid bodies.
 */
...
private:
	...
	void createTile(Scene& aScene, const TileInfo& aTileInfo, const std::string& aLayerName, int aLayerIndex,
